...
const Header = () => {
  ...
  return (
    <>
      <ToastContainer />
      <div className="w-full top-0 shadow-md fixed z-50 bg-white">
        <div className="container mx-auto flex flex-wrap p-3 flex-col md:flex-row items-center">
         ...
         { User1 && <div className="flex-grow text-center">
          ...
          <nav className="md:ml-auto md:py-1 md:pl-4	flex flex-wrap items-center text-base justify-center">
            <NavLink to={"/:id"} className="mr-5 hover:text-gray-900">
              Home
            </NavLink>
            <NavLink to={"/checkout"} className="mr-5 hover:text-gray-900">
              Checkout
            </NavLink>
